...
<header class="header mb-5">
      ...
      *** TOPBAR ***
              ...
              <div class="modal-body">
                <form action="login" method="post">
                  <div class="form-group">
                    <input name = "email" id="email-modal" type="email" placeholder="email" class="form-control">
                  </div>
                  <div class="form-group">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.html" class="navbar-brand home"><img src="static/img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="static/img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
