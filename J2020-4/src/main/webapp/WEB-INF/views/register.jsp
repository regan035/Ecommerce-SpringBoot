          ...
          <div class="row">
              ...
              <div class="box">
                ...
                <h3 class="text-danger">${error}</h3>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="email" type="email" class="form-control" placeholder="Last Name"/>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="password2" type="text" class="form-control" placeholder="Re-enter password"/>
            ...
            <div class="col-lg-6">
              <div class="box">
                ...
                <p class="text-muted">${msg} <span class="text-danger">${error}</span></p>
                <hr>
